<footer class="footer">
 ...
 <p class="footer__texto">
    Technological Workshop es una conferencia para desarrolladores de todos los niveles y para todas aquellas personas que esten interesadas en el mundo de la tecnologia,
